from skadi_ext.decoder cimport dt as dcdr_dt
from skadi.state.util import Entity, PVS


cpdef PacketEntitiesDecoder mk(recv_table_by_cls):
    return PacketEntitiesDecoder(recv_table_by_cls)


cdef class PacketEntitiesDecoder(object):
    def __init__(PacketEntitiesDecoder self, object recv_table_by_cls):
